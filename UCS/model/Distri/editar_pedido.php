...
$queryid = "SELECT Correo FROM usuarios WHERE nombre = '" . $_SESSION['usuario'] . "'";
...
<div class="container">
    <form action="add_product_edit.php" method="post">
        <br>
        <div class="form-group">
            ...
            <div style="display: none;">
                ...
                <input type="number" class="form-control" name="id_pedido" id="id_pedido"
                ...
                ?>
                <input type="text" name="fecha_prod" value="<?php echo $fecha_time; ?>">
            </div>
        ...
        <table class="table table-striped table-hover">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <form action='../eliminar/eliminar_edit.php' method='POST'
                            onclick="return confirm('¿Estas seguro que quieres eliminar este producto?')">
...
?>
        <form action="solicitar_pedido.php" method="POST" onclick="return confirm('¿Desea realizar este pedido?')">
            ...
            <div style="display: none;">
                ...
                <input name="subject" value="Se ha realizado un nuevo pedido">
            </div>
            ...
            <!-- ------------------ Fin del bloque ----------------------- -->
                <div class="text-center">
                    <button type="submit" name="send" class="btn btn-primary btn-sm">Solicitar Pedido <i class='bx bxs-cart'></i></button>
                </div>
