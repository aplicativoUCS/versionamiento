...
<head>
    ...
    <!--Google Fonts-->
    <link href='http://fonts.googleapis.com/css?family=Roboto+Condensed:400italic,700italic,400,300,700'
        ...
        <div class="contact-main">
            <form method="post">
				...
				if (isset($_POST['send'])) {
					...
					$mail_username = "ticketprocessmedilaser@gmail.com"; //Correo electronico saliente ejemplo: tucorreo@gmail.com
					$mail_userpassword = "tlqdgubxnvrqxnuq"; //Tu contraseña de gmail
					$mail_addAddress = "dfgrijalbaa@medilaser.com.co"; //correo electronico que recibira el mensaje
